...
def assert_skill_contract() -> None:
    ...
    required = [
        ...
        "For paper capture requests, delegate to `loreforge-paper`",
        "Do not delegate paper capture to",
        "For ordinary paper ingest, stop after the paper-note update",
        "Only continue to Cards, Atlas, Sources, Spaces, or cross-domain",
